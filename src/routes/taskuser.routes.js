...
router.put('/:TaskUserID', [authJwt.verifyToken, authJwt.isLiderOrAdmin], taskUserCtrl.updateTaskUserById); //Actualizar el estado y descripción de la tarea asignada al usuario
